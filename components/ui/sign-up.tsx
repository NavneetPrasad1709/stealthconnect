...
const GlassInput = ({ children }: { children: React.ReactNode }) => (
  <div
    ...
    style={{ border:"1px solid rgba(255,255,255,0.1)", background:"rgba(255,255,255,0.04)", backdropFilter:"blur(8px)" }}
        ...
        <div className="w-full max-w-md relative z-10 flex flex-col gap-5 py-6">
          ...
          <div className="animate-element animate-delay-200">
            <h1 className="text-4xl sm:text-5xl font-light leading-tight tracking-tight text-white" style={{ fontFamily: F }}>
              Create<br/>
              <span className="font-black" style={{ color: "var(--brand)" }}>account.</span>
            </h1>
            <p className="mt-2 text-sm flex items-center gap-2" style={{ color: "rgba(255,255,255,0.38)", fontFamily: F }}>
          ...
          {/* Google */}
          <button
            type="button" onClick={onGoogleSignUp} disabled={isDisabled}
            className="animate-element animate-delay-300 w-full flex items-center justify-center gap-3 rounded-2xl py-4 text-sm font-medium text-white transition-all duration-200 disabled:opacity-50"
          ...
          {/* Divider */}
          <div className="animate-element animate-delay-400 relative flex items-center">
            <span className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.07)" }}/>
            <span className="px-4 text-xs uppercase tracking-widest" style={{ color:"rgba(255,255,255,0.2)", fontFamily:F }}>or</span>
            <span className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.07)" }}/>
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={onSignUp}>
            ...
            <div className="animate-element animate-delay-400 flex flex-col gap-1.5">
              <label className="text-sm font-medium" style={{ color:"rgba(255,255,255,0.45)", fontFamily:F }}>Full Name</label>
              <GlassInput>
            ...
            <div className="animate-element animate-delay-500 flex flex-col gap-1.5">
              <label className="text-sm font-medium" style={{ color:"rgba(255,255,255,0.45)", fontFamily:F }}>Email Address</label>
              <GlassInput>
            ...
            <div className="animate-element animate-delay-500 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium" style={{ color:"rgba(255,255,255,0.45)", fontFamily:F }}>
                  LinkedIn <span style={{ color:"rgba(255,255,255,0.2)", fontWeight:400 }}>(optional)</span>
                </label>
                <GlassInput>
            ...
            <div className="animate-element animate-delay-600 flex flex-col gap-1.5">
              <label className="text-sm font-medium" style={{ color:"rgba(255,255,255,0.45)", fontFamily:F }}>Password</label>
              <GlassInput>
            ...
            <button type="submit" disabled={isDisabled}
              className="animate-element animate-delay-700 w-full rounded-2xl py-4 text-sm font-semibold text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
          ...
          <p className="animate-element animate-delay-800 text-center text-sm" style={{ color:"rgba(255,255,255,0.3)", fontFamily:F }}>
